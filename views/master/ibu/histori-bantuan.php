            ...
            <div class="w-full bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                <div class="flex justify-between items-center mb-6">
                    <div>
                        ...
                        <p class="text-sm text-gray-500">Riwayat bantuan yang telah diterima dari posyandu.</p>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-gray-100 text-sm text-gray-700">
                            <?php if (!empty($bantuans)): ?>
                                <?php $no = 1; foreach ($bantuans as $bantuan): ?>
                                    <tr>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
                                    <td colspan="7" class="py-8 text-center text-gray-400">Belum ada data bantuan.</td>
                                </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
