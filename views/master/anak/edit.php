<?php
$pageTitle = 'Ubah Data Anak';
$pageSubtitle = 'Perbarui data tumbuh kembang balita Anda.';
        ...
        <form action="/master/anak/update" method="POST" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="NIK_anak"
                    value="<?= htmlspecialchars($anak['NIK_anak'] ?? ''); ?>"
                    inputmode="numeric" pattern="[0-9]{16}" minlength="16" maxlength="16" required
            ...
            <div>
                ...
                <input type="text" name="nama_anak"
                    value="<?= htmlspecialchars($anak['nama_anak']); ?>"
                    required placeholder="Nama lengkap balita"
                    class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none text-sm transition">
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="date" name="tgl_lahir"
                        value="<?= htmlspecialchars($anak['tgl_lahir']); ?>"
                        required
                        class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none text-sm transition">
                </div>
                <div>
