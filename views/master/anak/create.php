...
?>
        ...
        <main class="flex-1 p-6 flex flex-col items-center pt-2">
            ...
            <?php if (isset($_SESSION['success'])): ?>
                <div class="bg-green-100 text-green-800 p-4 rounded mb-4"><?= $_SESSION['success'] ?></div>
                <?php unset($_SESSION['success']); ?>
            <?php endif; ?>
            <?php if (isset($_SESSION['error'])): ?>
                <div class="bg-red-100 text-red-800 p-4 rounded mb-4"><?= $_SESSION['error'] ?></div>
                ...
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                    ...
                    <form action="/master/anak/store" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="text" name="NIK_anak" maxlength="16" required placeholder="Masukkan 16 digit NIK" class="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-teal-500 focus:border-teal-500 outline-none text-sm transition">
                        </div>
