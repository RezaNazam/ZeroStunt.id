...
*/
$tableRows = $satuans;
$tableEmptyMessage = 'Belum ada data satuan.';
...
$tableColumns = [
    ...
    [
        'label' => 'Singkatan',
        'render' => function ($row) {
            return '<span class="px-3 py-1 rounded-full bg-teal-50 text-teal-700 text-xs font-bold">' .
                htmlspecialchars($row['singkat']) .
                '</span>';
        }
    ],
    [
        ...
        'td_class' => 'text-right',
        'render' => function ($row) {
            $id = urlencode($row['id_satuan']);

            return '
                <div class="flex justify-end gap-2">
                    <a href="/master/satuan/edit?id=' . $id . '"
    ...
    <div class="overflow-hidden rounded-3xl border border-gray-100 bg-white shadow-sm">
        <div class="border-b border-gray-100 px-6 py-5 flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                ...
                <p class="text-sm text-gray-500 mt-1">
                    Total data: <?= $tablePagination['total_data'] ?? count($satuans); ?> satuan
                </p>
            </div>
            ...
            <div class="w-full lg:max-w-md">
                ...
                $searchPlaceholder = 'Cari nama satuan atau singkatan...';
