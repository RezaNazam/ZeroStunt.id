...
$pageSubtitle = 'Laporan menyeluruh data anak, stok, pengadaan, distribusi, dan penyerahan bantuan.';
...
<div class="space-y-6">
    <div class="rounded-3xl bg-white border border-gray-100 shadow-sm p-6">
        <div class="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
            <div>
                <h1 class="text-2xl font-extrabold text-gray-900">Laporan Admin</h1>
    ...
    <section class="grid md:grid-cols-4 gap-4">
        ...
        <div class="rounded-3xl bg-white border border-gray-100 shadow-sm p-6">
            <p class="text-sm text-gray-500">Pengadaan</p>
            <p class="text-3xl font-extrabold text-amber-600 mt-2"><?= $summary['total_pengadaan'] ?? 0; ?></p>
        </div>

        <div class="rounded-3xl bg-white border border-gray-100 shadow-sm p-6">
            <p class="text-sm text-gray-500">Penyerahan</p>
            <p class="text-3xl font-extrabold text-blue-700 mt-2"><?= $summary['total_penyerahan'] ?? 0; ?></p>
        </div>
    </section>
    ...
    <section class="grid md:grid-cols-4 gap-4">
        ...
        <div class="rounded-3xl bg-white border border-gray-100 shadow-sm p-6">
            <p class="text-sm text-gray-500">Jenis Stok Pusat</p>
            <p class="text-3xl font-extrabold text-teal-700 mt-2"><?= $summary['jenis_stok_pusat'] ?? 0; ?></p>
        </div>
    </section>

    <div class="rounded-3xl bg-white border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-xl font-extrabold text-gray-900">Pemeriksaan Anak</h2>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left px-6 py-4">Posyandu</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if (empty($pemeriksaan)): ?>
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-500">Belum ada pemeriksaan pada periode ini.</td>
                        </tr>
                    <?php endif; ?>
                    ...
                    <?php foreach ($pemeriksaan as $row): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= htmlspecialchars($row['nama_posyandu'] ?? '-'); ?></td>
                            <td class="px-6 py-4">
    ...
    <div class="rounded-3xl bg-white border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-xl font-extrabold text-gray-900">Pengadaan</h2>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left px-6 py-4">Petani</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <?php foreach ($pengadaan as $row): ?>
                        <tr>
                            <td class="px-6 py-4"><?= date('d/m/Y', strtotime($row['tgl_pengadaan'])); ?></td>
                            <td class="px-6 py-4 font-mono font-bold"><?= htmlspecialchars($row['no_kontrak'] ?? '-'); ?></td>
                            <td class="px-6 py-4"><?= htmlspecialchars($row['nama_petani'] ?? '-'); ?></td>
    ...
    <div class="rounded-3xl bg-white border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-xl font-extrabold text-gray-900">Stok Gudang Pusat</h2>
        </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full text-sm">
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if (empty($stok)): ?>
                        <tr>
                            <td colspan="5" class="px-6 py-8 text-center text-gray-500">Belum ada stok gudang pusat.</td>
                        </tr>
                    <?php endif; ?>
    ...
    <div class="rounded-3xl bg-white border border-gray-100 shadow-sm overflow-hidden">
        <div class="px-6 py-5 border-b border-gray-100">
            <h2 class="text-xl font-extrabold text-gray-900">Distribusi</h2>
        </div>
            ...
            <table class="w-full text-sm">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="text-left px-6 py-4">Tujuan</th>
                ...
                <tbody class="divide-y divide-gray-100">
                    <?php if (empty($distribusi)): ?>
                        <tr>
                            <td colspan="6" class="px-6 py-8 text-center text-gray-500">Belum ada distribusi pada periode ini.</td>
                        </tr>
                    <?php endif; ?>
                    ...
                    <?php foreach ($distribusi as $row): ?>
                        <tr>
                            ...
                            <td class="px-6 py-4"><?= htmlspecialchars($row['gudang_tujuan'] ?? '-'); ?></td>
