...
$renderAdminPengadaanTable = function ($daftar_kontrak) use ($data) {
    ?>
                ...
                <tbody class="divide-y divide-gray-100">
                    ...
                    <?php foreach ($daftar_kontrak as $p): ?>
                            <tr class="hover:bg-gray-50">
                                ...
                                <td class="px-6 py-4">
                                    <span class="px-2.5 py-1 text-xs font-bold rounded-full <?= ($p['status_kontrak'] ?? '') === 'Disetujui' ? 'bg-green-100 text-green-700' : 'bg-amber-100 text-amber-700' ?>">
